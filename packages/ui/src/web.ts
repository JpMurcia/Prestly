...
export { SegmentedControl } from './primitives-web/SegmentedControl';
export type { SegmentedControlProps, SegmentedControlOption } from './primitives-web/SegmentedControl';
